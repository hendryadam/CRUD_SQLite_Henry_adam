package com.example.crudsqlite_henryadam
...
class AdapterMataKuliah (
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (listLayout == null) {
            ...
            listLayout = infLateList.inflate(R.layout.item, parent, false) //activity item = layout_mata_kuliah di slide ke 4 pert 13-14
            holder = ViewHolder()
            with(holder) {
